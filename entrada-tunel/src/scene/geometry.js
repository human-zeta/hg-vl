...
// Caja centrada en el origen, con normales planas y baricentricas.
// Triangulos sueltos por el mismo motivo que la icosfera: cada cara necesita su
// normal propia y cada vertice su baricentrica.
    ...
    for (const f of faces) {
        for (const tri of [[0, 1, 2], [0, 2, 3]]) {
            for (let k = 0; k < 3; k++) {
                ...
                bary[o] = BARY[k][0]; bary[o + 1] = BARY[k][1]; bary[o + 2] = BARY[k][2];
                o += 3;
            }
        }
    }
...
export class Mesh {
    ...
    constructor(gl, lib, data, opts = {}) {
        ...
        // Identidad, no ceros.
        //
        // `new Float32Array(16)` arranca en cero, y una matriz nula manda todo
        // vertice a (0,0,0,0): la malla desaparece sin ningun error. Una malla
        // que no necesita transformacion —la escalera ya viene colocada por
        // sus atributos de instancia— nunca llama a setTransform, y sin esto
