...
export class Post {
    constructor(gl, lib, width, height, quality) {
        ...
        // Corrección de color. Sombras levemente frias, altas neutras, medios
        // apenas comprimidos: es el acabado que sostiene una escena oscura sin
        // que el negro se vea plano.
        this.grade = {
